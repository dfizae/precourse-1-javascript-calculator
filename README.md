...
- 미션 구현을 완료한 후 GitHub을 통해 제출해야 한다.
    - GitHub을 활용한 제출 방법은 [프리코스 과제 제출](https://github.com/woowacourse/woowacourse-docs/tree/main/precourse) 문서를 참고해
      제출한다.
- GitHub에 미션을 제출한 후 [우아한테크코스 지원 플랫폼](https://apply.techcourse.co.kr)애 PR 링크를 포함하여 최종 제출한다.
    - 자세한 방법은 [제출 가이드](https://github.com/woowacourse/woowacourse-docs/tree/main/precourse#제출-가이드) 참고
...
> 1. 커스텀연산자 설정 시 // \n 사이에 한꺼번에 넣어서 지정해보기
> *예: 입력: //^#\n1^2:3,4#5    출력: 결과 : 15 
> 2. 입력한 값이 없는 경우 0을 반환
> *예: 입력: "" 출력: 결과 : 0
> 3. 음수를 넣었을 때 음수를 넣어서 오류라는 걸 확실하게 표기하기
> * 음수를 넣으면 안되는 걸 확실하게 알려주는게 이용자 입장에서 유용할 거 같다.
